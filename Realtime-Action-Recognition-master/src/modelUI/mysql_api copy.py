...
def init_db():
    ...
    with db:
        ...
        # TABLE comp_stats
        cur.execute('CREATE TABLE IF NOT EXISTS comp_stats(FOREIGN KEY contestant_id REFERENCES contestant(id), contest_num INT, contest_tot_secs INT, \
        ...
        cur.execute('CREATE TABLE IF NOT EXISTS technique_stats(FOREIGN KEY contestant_id REFERENCES contestant(id), \
        ...
        # TABLE body_stats
        cur.execute('CREATE TABLE IF NOT EXISTS body_stats(FOREIGN KEY contestant_id REFERENCES contestant(id), \
        ...
        cur.execute('CREATE TABLE IF NOT EXISTS competition (id INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255), date DATE, location VARCHAR(255), log LONGTEXT, \
                    ...
                    FOREIGN KEY (red_contestant_id) REFERENCES contestant(id), FOREIGN KEY (blue_contestant_id) REFERENCES contestant(id), FOREIGN KEY (winner_id) REFERENCES contestant(id))')
        db.commit()
    # db.close()
